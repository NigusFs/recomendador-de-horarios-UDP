...
#
lista_secciones = [
	{'codigo':"CBF1000_CA05",'nombre':"MECÁNICA", 'seccion':"Sección 5", "horario":["VI 08:30","JU 14:00","VI 14:00"], "profesor": "LAVIN ROBERTO OSVALDO"},
	{'codigo':"CBF1000_CA07",'nombre':"ESTRUCTURAS DE DATOS", 'seccion':"Sección 10", "horario":["LU 17:25","JU 17:25","VI 17:25"] ,"profesor": "EREMEEV VITALIE"},
	{'codigo':"CBF1000_CA010",'nombre':"MECÁNICA", 'seccion':"Sección 7", "horario":["LU 10:00","JU 10:00","VI 10:00"] ,"profesor": "LEON ALEJANDRO"}
	]
...
def get_preferencias():
	...
	return {"ramos_830":ramos_830, "ramos_1725": 2, "profesores":profesores}
...
### Condiciones horarias 
	...
	if value_encuesta["ramos_830"] == 3:
		...
		if 	bloque_a:
			peso_ponderado += value_encuesta["ramos_830"]*3 #este 3 es la importancia que le damos a este parametro (dejar estos parametros en un arreglo para cambiarlos facil) #complemento de 10 # importanacia horario
		else:
			peso_ponderado += (value_encuesta["ramos_830"])//3
